...
function themtuts_plyr_css_and_js_files() {
    echo "<link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/plyr@3.6.4/dist/plyr.css?ver=3.6.4'>";
    echo "<script type='text/javascript' src='https://cdn.jsdelivr.net/npm/plyr@3.6.4/dist/plyr.js?ver=3.6.4'></script>";
